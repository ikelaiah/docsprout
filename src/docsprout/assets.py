...
.site-header{position:sticky;top:0;z-index:2;border-bottom:1px solid var(--dk-border);background:var(--dk-bg);box-shadow:0 1px 0 color-mix(in srgb,var(--dk-border) 55%,transparent),0 .45rem 1.4rem -1.15rem color-mix(in srgb,#000 45%,transparent)}
...
.sidebar{position:sticky;top:5.75rem;max-height:calc(100vh - 7rem);overflow:auto;padding-right:.35rem;font-size:.86rem;line-height:1.45;scrollbar-color:var(--dk-border) transparent;scrollbar-width:thin}
...
.sidebar h2{margin:1.85rem 0 .55rem;padding-left:.7rem;color:var(--dk-muted);font-family:var(--dk-font-display);font-size:.75rem;font-weight:700;letter-spacing:.13em;text-transform:uppercase}
...
html[data-visual-theme="paper"] .prose{padding:clamp(1.25rem,3vw,2.25rem);border:1px solid var(--dk-border);background:var(--dk-raised);box-shadow:0 .4rem 2rem #0001}
html[data-visual-theme="paper"] .prose :is(h1,h2,h3){letter-spacing:-.018em}
...
html[data-visual-theme="e-ink"] :is(.prose pre,.capability-strip li,.search-results,.hero){box-shadow:none;border-color:var(--dk-border);border-radius:.15rem}
...
html[data-visual-theme="e-ink"] .table-scroll{border-color:var(--dk-text);border-radius:.15rem}
...
.capability-strip{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;grid-template-rows:minmax(0,1fr);gap:var(--dk-space-3);margin:0 0 2.75rem;padding:0;list-style:none}
.capability-strip li{display:flex;flex-direction:column;align-self:stretch;min-height:0;padding:1.1rem 1.15rem;border:1px solid var(--dk-border);border-radius:.55rem;max-width:none;background:var(--dk-raised);box-shadow:0 1px 0 color-mix(in srgb,var(--dk-border) 70%,transparent);line-height:1.5;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}
...
.capability-strip span{display:block;margin-top:.35rem;color:var(--dk-muted);font-size:.78rem;line-height:1.5}
...
.table-scroll{overflow:auto;margin:1.5rem 0;border:1px solid var(--dk-border);border-radius:.5rem;-webkit-overflow-scrolling:touch;scrollbar-color:var(--dk-border) transparent;scrollbar-width:thin}
...
.banner{display:block;width:100%;max-width:100%;height:auto;max-height:16rem;margin:0 0 1.75rem;border:1px solid var(--dk-border);border-radius:.5rem;object-fit:cover}
.search-results{position:absolute;top:100%;left:max(1rem,calc((100% - var(--dk-shell-width))/2 + 16rem));width:min(34rem,calc(100% - 2rem));max-height:min(60vh,30rem);overflow:auto;padding:.45rem;background:var(--dk-raised);border:1px solid var(--dk-border);border-radius:.45rem;box-shadow:var(--dk-shadow)}
...
.toc a{display:block;padding:.3rem .6rem;border-left:2px solid transparent;color:var(--dk-muted);text-decoration:none;overflow-wrap:anywhere}.toc a:hover{color:var(--dk-text);text-decoration:underline;text-underline-offset:.2em}.toc .toc-level-3{padding-left:1.15rem;font-size:.94em}.toc-empty-copy{margin:0;font-size:.9em}
.page-navigation{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:var(--dk-space-3);margin:4rem 0 1rem;padding-top:1.25rem;border-top:1px solid var(--dk-border)}.page-navigation a{min-height:0;max-width:none;padding:0;border:0;border-radius:0;background:transparent;display:flex;flex-direction:column;color:var(--dk-text);font-family:var(--dk-font-display);text-decoration:none}.page-navigation a small{font-family:var(--dk-font-mono);font-size:.68rem;letter-spacing:.06em;text-transform:uppercase;color:var(--dk-muted)}.page-navigation a span{margin-top:.15rem;font-size:1rem;line-height:1.4}.page-navigation a:hover span{color:var(--dk-interactive);text-decoration:underline;text-decoration-thickness:.08em;text-underline-offset:.16em}.page-navigation .page-next{grid-column:2;margin-left:0;justify-self:end;text-align:right;align-items:flex-end}
.site-footer{display:flex;gap:1rem;flex-wrap:wrap;max-width:var(--dk-shell-width);margin:0 auto;padding:1.25rem clamp(1rem,3vw,2rem);border-top:1px solid var(--dk-border);color:var(--dk-muted);font-family:var(--dk-font-ui);font-size:.82rem}.site-footer a{color:var(--dk-interactive);font-weight:650;text-decoration-thickness:.08em;text-underline-offset:.16em}
...
/* v1.5 — glassmorphic: a viewport-anchored mesh under frosted chrome with
   specular edges. Panels share one recipe: a raised sheen over a mostly-opaque
   surface, a defined border and a top hairline. Tints and translucency stay
   inside the bounds covered by the shipped worst-case composites in
   palette.py, and blur is progressive enhancement over the solid tokens. */
html[data-visual-theme="glassmorphic"] body{background:radial-gradient(46rem 32rem at 10% -12%,color-mix(in srgb,var(--dk-accent) var(--dk-mesh-1),transparent),transparent 58%),radial-gradient(38rem 30rem at 94% 0%,color-mix(in srgb,var(--dk-accent-secondary) var(--dk-mesh-2),transparent),transparent 55%),radial-gradient(42rem 34rem at 52% 118%,color-mix(in srgb,var(--dk-accent) var(--dk-mesh-3),transparent),transparent 60%),radial-gradient(28rem 24rem at 76% 74%,color-mix(in srgb,var(--dk-accent-secondary) var(--dk-mesh-4),transparent),transparent 55%),var(--dk-bg);background-attachment:fixed}
...
html[data-visual-theme="glassmorphic"] .hero{border-radius:1.5rem}
...
html[data-visual-theme="glassmorphic"] :is(.capability-strip li,.search-results,.sidebar,.toc){border-radius:1.15rem}
html[data-visual-theme="glassmorphic"] :is(.sidebar,.toc){padding:.95rem 1.05rem;border-width:1px;border-style:solid}
html[data-visual-theme="glassmorphic"] .release-context{border-radius:.65rem}
html[data-visual-theme="glassmorphic"] .topbar :is(select,button,.search-control input){background:color-mix(in srgb,var(--dk-surface) 78%,transparent);border-color:color-mix(in srgb,var(--dk-raised) 30%,var(--dk-border));border-radius:.75rem;box-shadow:inset 0 1px 0 color-mix(in srgb,var(--dk-raised) 55%,transparent)}
...
@supports ((background-clip:text) or (-webkit-background-clip:text)){html[data-visual-theme="glassmorphic"] .hero h1{background:linear-gradient(175deg,var(--dk-interactive) 15%,var(--dk-accent) 85%);-webkit-background-clip:text;background-clip:text;color:transparent}}
