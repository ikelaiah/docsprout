...
[`docs/docsprout.json`](https://github.com/ikelaiah/docsprout/blob/v1.1.0/docs/docsprout.json)
and its [local SVG asset](https://github.com/ikelaiah/docsprout/blob/v1.1.0/docs/assets/docsprout-mark.svg).
