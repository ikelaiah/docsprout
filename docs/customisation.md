...
[`docs/dockit.json`](https://github.com/ikelaiah/dockit-fp/blob/v0.18.1/docs/dockit.json)
and its [local SVG asset](https://github.com/ikelaiah/dockit-fp/blob/v0.18.1/docs/assets/dockit-mark.svg).
