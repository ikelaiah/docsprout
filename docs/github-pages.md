...
workflow to the installed release, such as `@v1.1.3`. It never follows
...
jobs:
  documentation:
    permissions:
      ...
      pages: write
      id-token: write
    uses: ikelaiah/docsprout/.github/workflows/publish-docs.yml@v1.1.3
    with:
      versioned: false
      release: latest
```

The maintained [single-version example](https://github.com/ikelaiah/docsprout/tree/v1.1.3/examples/single-version)
uses this form.
...
The maintained [historical example](https://github.com/ikelaiah/docsprout/tree/v1.1.3/examples/historical)
