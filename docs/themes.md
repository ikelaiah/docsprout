...
The maintained
[single-version example](https://github.com/ikelaiah/docsprout/tree/v1.1.1/examples/single-version)
...
The maintained
[minimal example](https://github.com/ikelaiah/docsprout/tree/v1.1.1/examples/minimal)
